...
const ::uint32_t
    TableStruct_example_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::myproto::Person, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::myproto::Person, _impl_.id_),
        PROTOBUF_FIELD_OFFSET(::myproto::Person, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::myproto::Person, _impl_.emails_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::myproto::Person)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::myproto::_Person_default_instance_._instance,
};
const char descriptor_table_protodef_example_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\rexample.proto\022\007myproto\"2\n\006Person\022\n\n\002id"
    "\030\001 \001(\005\022\014\n\004name\030\002 \001(\t\022\016\n\006emails\030\003 \003(\tb\006pr"
    "oto3"
};
...
Person::Person(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:myproto.Person)
}
inline PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::myproto::Person& from_msg)
...
Person::Person(
  ...
  // @@protoc_insertion_point(copy_constructor:myproto.Person)
}
inline PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:myproto.Person)
...
const ::_pbi::TcParseTable<2, 3, 0, 33, 2> Person::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::myproto::Person>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:myproto.Person)
...
::uint8_t* Person::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:myproto.Person)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "myproto.Person.name");
  ...
  for (int i = 0, n = this->_internal_emails_size(); i < n; ++i) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "myproto.Person.emails");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:myproto.Person)
  return target;
}

::size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:myproto.Person)
  ::size_t total_size = 0;
...
void Person::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:myproto.Person)
...
// @@protoc_insertion_point(class_specific_copy_from_start:myproto.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
